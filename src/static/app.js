document.addEventListener("DOMContentLoaded", () => {
        ...
        const participantsListHtml = details.participants.length > 0
          ? details.participants.map(p => `
              <li>
                ...
                <button class="delete-btn" data-activity="${encodeURIComponent(name)}" data-email="${encodeURIComponent(p)}" title="Unregister participant">&times;</button>
              </li>
            `).join("")
  ...
  // Handle participant deletion (unregister)
